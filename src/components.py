...
def get_default_dic_mpe():
    default_dic = dict()
    default_dic.update(
        {"e_var": [dcc.Dropdown(id={'type': 'dd_e_mpe', 'index': 0}, options=sorted(in_use_tree.varnames))]})
    ...
    default_dic.update({"q_var": [
        dcc.Dropdown(id="text_var_mpe", options=sorted(in_use_tree.varnames), value=sorted(in_use_tree.varnames),
...
def get_default_dic_pos():
    default_dic = dict()
    default_dic.update(
        {"e_var": [dcc.Dropdown(id={'type': 'dd_e_pos', 'index': 0}, options=sorted(in_use_tree.varnames))]})
    ...
    default_dic.update({"q_var": [dcc.Dropdown(id="text_var_pos", options=sorted(in_use_tree.varnames),
                                           value=sorted(in_use_tree.varnames), multi=True, disabled=False)]})
    default_dic.update({'page': 0})
